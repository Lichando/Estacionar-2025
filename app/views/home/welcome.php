	...
	<header>
		...
		<div class="carousel-caption">
			...
			<div class="carousel-logo">
				<img src="public/img/logoestacionar.png" alt="Logo">
			</div>
			<div>
				<a href="auth/login" class="btn btn-primary fw-semibold">Acceder, ahora mismo!</a>
			</div>
		</div>
	</header>
	...
	<section class="section-padding bg-light text-center">
		<div class="container">
			...
			<div class="profile-container">
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 1">
					<p>Franco</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 2">
					<p>Lisandro</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 3">
					<p>Maximo</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 4">
					<p>Walter</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 5">
					<p>Mauricio</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 6">
					<p>Emanuel</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 7">
					<p>Luis</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 8">
					<p>Florencia</p>
				</div>
				<div class="profile">
					<img src="public/img/user.png" alt="Nombre 8">
