<nav class="navbar bg-body-tertiary fixed-top">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body">
            ...
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3" aria-labelledby="dropdownMenuButton">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img src="../img/user.png" style="width: 50px;">
                        Mis datos
                    </a>
                ...
                <li class="nav-item"><a class="nav-link" href='#'>
                        <a><img src="../img/user.png" style="width: 50px;">Estacionar
                            Ahora!</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li><a class="dropdown-item" href="#PATH#terminos/politicas">Funcionamiento App</a></li>
                        <li><a class="dropdown-item" href="#PATH#terminos/politicas">Nosotros</a></li>
                        <li><a class="dropdown-item" href="#PATH#terminos/politicas">Iniciativa</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="nav-link" href='#'>
